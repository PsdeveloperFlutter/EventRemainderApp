        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                ...
                icon: Icon(
                    themeController.changemode == 1
                        ? Icons.nightlight_round
                        : Icons.wb_sunny_outlined,
                    color: themeController.changemode == 1
                      ...
                      builder: (BuildContext context) {
                        return Consumer(builder: (context, ref, child) {
                          return AlertDialog(
                            ...
                            // Your title here
                            content: const Text(
                                'Are you sure you want to retrieve data.'),
                            // Your content here
                            actions: <Widget>[
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: AbsorbPointer(
                child: _buildTextField(_eventDateTimeController,
            ...
            GestureDetector(
              onTap: () async {
                if (_eventDateTimeController.text.isEmpty) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text("Please Enter Event Location")));
                  ...
                  AttachWithDB newEvent = AttachWithDB(
                    ...
                    file: file,
                    // Keep structure (can add file picker)
                    image: image,
                    // Keep structure (can add image)
                    video: video,
                    // Keep structure (can add video)
                    customCategory:
...
Widget _buildMediaButton(IconData icon, String label, VoidCallback onPressed) {
  return Column(
    children: [
      IconButton(
          onPressed: onPressed, icon: Icon(icon, color: Colors.deepOrange)),
      Text(
        label,
